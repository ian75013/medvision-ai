...
Python, PyTorch basics, computer vision fundamentals, 3D tensor manipulation.
...
\midrule
\endhead
  AI for Medicine Specialization & \href{https://www.coursera.org/specializations/ai-for-medicine}{\texttt{link}} & Medical image analysis. \\
\bottomrule
\caption{Coursera}
\end{longtable}
...
\midrule
\endhead
  Advanced Computer Vision & \href{https://www.pluralsight.com/courses/advanced-computer-vision}{\texttt{link}} & Segmentation and classification patterns. \\
\bottomrule
\caption{Pluralsight}
\end{longtable}
...
\begin{itemize}[leftmargin=1.5em]
  \item \href{https://github.com/Project-MONAI/MONAI}{\textbf{Project-MONAI/MONAI}} — Medical image framework.
\end{itemize}
